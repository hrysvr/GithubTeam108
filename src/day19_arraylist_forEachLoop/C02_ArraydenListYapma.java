    ...
    public static void main(String[] args) {
        ...
        /*
           ...
           2- asList() kullanmak
              ...
              - asList() ile olusturulan list, array'dan donusturuldugu icin
                add, remaove gibi size'i degistiren method'lar kullanilamaz
              - asList() ile olusturulan list ile bagli oldugu array
                birbirinden ayrilmiyor
                birinde yapacaginiz degisiklik, otomatik olarak digerini de etkiliyor
         */
        ...
        // loop ile tasinan list: [2, 3, 4, 6, 3, 4, 6, 1, 8, 5, 4]


        List<Integer> list2 = Arrays.asList(arr);
        System.out.println("asList ile olusturulan list: " + list2);
        // asList ile olusturulan list: [2, 3, 4, 6, 3, 4, 6, 1, 8, 5, 4]


        // list2.add(6); (hata verme sebebi 18. satirda yaziyor)
