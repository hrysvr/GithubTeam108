...
public class C06_Soru {
    ...
    public static void main(String[] args) {
        ...
        enYuksekEnDusukFiyatYazdir(fiyatlar); // Listedeki en dusuk fiyat : 3.4
    ...
    public static void enYuksekEnDusukFiyatYazdir(double[] fiyatlar){
        ...
        System.out.println("Listedeki en dusuk fiyat : " + enDusukFiyat); // Listedeki en dusuk fiyat : 3.4
        System.out.println("Listedeki en yuksek fiyat : " + enYuksekFiyat); // Listedeki en yuksek fiyat : 42.1
    }
