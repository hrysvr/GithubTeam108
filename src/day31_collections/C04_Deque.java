...
public class C04_Deque {
    ...
    public static void main(String[] args) {
        ...
        // iki yonlu kuyruk anlamina gelir
        // Bu iki yonlu yapisindan pek cok method'un first() ve last() versiyonu vardir
        ...
        System.out.println(harfler.removeLastOccurrence("I")); // false
