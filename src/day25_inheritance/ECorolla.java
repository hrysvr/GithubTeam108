...
public class ECorolla extends DToyota {
    ...
    ECorolla(String param1){
        super("Gri");
        System.out.println("String parametreli Corolla constructor'i calisti");
    }
    ...
    /*
       ...
       parent class'daki constructor'larda calismalidir

       Java bu calismayi super() constructor sayesinde saglar
